...
items-center px-4 py-2 bg-violet-800 dark:bg-gray-200 border border-transparent
 rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase
 tracking-widest hover:bg-violet-700 dark:hover:bg-white focus:bg-gray-700
